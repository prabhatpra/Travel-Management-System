...
public class CheckHotels extends JFrame implements Runnable {
    ...
    JLabel caption;
    public void run(){
        String[] text = new String[]{"JW Marriott Hotel", "Madarin Oriental Oriental Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel", "Classic Hotel", "The Bay Clue Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Moring Hotel", "River View HOtel"};
